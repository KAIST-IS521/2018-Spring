...
- Fork from the [repository](https://github.com/KAIST-IS521/2018s-virus) to your
  own public repository, and start implementing your virus. TAs will give this
  repository.
...
- At the very first run of your virus, it should infect binaries in the current
  ...
  After the first run, infected binaries shoulud run the same logic: it should
  infect other binary files when it runs. However, your virus should not detroy
...
- The repository should contain a well-documented README that describe your
  virus.
...
- To download Silvio's sample virus:
  ```FIXME```
...
- The repository should contain a well-documented README that describe your AV.
